...
const getTravelCompanion = async (req, res) => {
  try {
    ...
    //   filters['from.city_code'] = req.query.fromAirport
    // }
    ...
    if (zipcode) {
      ...
      var location = { type: "Point", coordinates: [lng, lat] };
      ...
      let pipeLine = [
        ...
        },
        {
          $addFields: {
            ...
            // tempcOnDate: {
            //   $cond: {
            //     if: { $ne: ["$cOn", ""] }, // Check if 'dateOfJourrney' is not empty
            //     then: "$cOn", // Set 'dateOfJourrney' as 'tempFromDate'
            //     else: "$cOn", // Set 'oldName' as 'toDate'
            //   },
            // },
          },
        },
